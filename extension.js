(function () {
				...
				if (!bot.commands.executable(this.rank, chat)) return void (0);
					...
					switch (randomInt) {
						...
						case 4:
							...
							break;
						case 5:
							API.sendChat("Everyone, do the shuffle!");
							break;
					}	
				}
			}
		...
		bot.commands.hugcommand = {
			...
			functionality: function(chat, cmd) {
				...
				if (!bot.commands.executable(this.rank, chat)) return void (0);
					...
					switch (randomInt) {
						case 1:
							API.sendChat("Aww, hugs to YOU!!");
							break;
						case 2:
							API.sendChat("HUGS!");
							break;
						case 3:
							API.sendChat("Bear Hug!");
							break;
						case 4:
							API.sendChat("Hugs for everyone!");
							break;
						case 5:
							API.sendChat("I want another hug!");
							break;
					}	
				}
			}
    ...
    $.getScript("https://rawgit.com/bottylicious/source/master/bottylicious.js", extend);
